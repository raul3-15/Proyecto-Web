...
/* Creacion del slider para cada app seleccionada */

function crearSliderApp() {
	...
	setTimeout(function(){
		...
		if(soportaCanvas){
			$('#div_slider_app img').each(function(){
		...
		$('#div_slider_app .flecha').click(function(){
